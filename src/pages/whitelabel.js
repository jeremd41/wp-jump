...
const whitelabel = () => (
  <Layout>
    ...
    <div className="grp-card1">
        <Card logo="fas fa-ghost" title="Entièrement en marque blanche" content="Nous utiliserons l'une de vos adresses e-mail (nous vous recommandons support@youragency.com) et aurons votre signature et votre logo au bas de chaque e-mail que nous vous enverrons." />
    ...
    <div className="grp-card1">
        ...
        <Card logo="fas fa-hand-holding-usd" title="Revendez nos plan avez votre marge" content="Exemple un forfait Solo vous coûte 3O€ /mois revendez en 10 à 70€ et vous dégagerez un bénéfice de 400€ en ayant rien à faire " />
    </div>
    <div className="bottom-border" />
    <Partner />
    <div className="bottom-border" />
